...
window.onload = function (e) {
    ...
    function initializeApp(data) {
      jQuery("#post").click(function () {
        jQuery.post(
          `https://csmju-559bb-default-rtdb.firebaseio.com/RichMenu/${this.$store.getters.getLine.userId}/profile.json`,
  ...
  methods: {
    Edit() {      
      ...
      if(this.validate()){
        ...
        this.$axios.patch(`https://csmju-559bb-default-rtdb.firebaseio.com/members/${this.$store.getters.getLine.userId}/profile.json`, this.$store.getters.getRegister).then((res) => {
